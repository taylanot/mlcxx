...
{
  \begin{itemize}
    \color{Pink} \item \color{Black} Learning-to-Learn paradigm: leverages similar learning problems (tasks) for a specific similar data-scarce learning problem (task).
...
\headerbox{5. Results for Task Variance ( $N = 1, \quad 10, \quad  50$ )
...
\headerbox{9. Experimentation}{name=future,column=2, below=conc, span=1}
{
  \begin{center}
