 ...
 *
 * header files for lcpp library
 *
 * For the ease of usage I only provide a global header, so you wont be able to 
 * call distinct parts with their headers. Later on, maybe I will add that 
 * functionality.
 *
 */
