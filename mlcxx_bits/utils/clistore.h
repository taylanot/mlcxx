...
// CLIStore
//=============================================================================
// This is a command line interface storing singleton.
...
/*   // Get flag options by name (long or short) */
/*   template<typename T> */
/*   T GetOptions(const std::string& name) const */
/*   { */
/*     auto it = flags_.find(name); */
/*     if (it == flags_.end()) */
/*     { */
...
/*           throw std::runtime_error("Error: Unknown short flag '-" */ 
/*               + shortFlag + "'"); */
...
/*   std::string GenName(const std::vector<std::string>& include_keys) */
/*   { */
/*     std::vector<std::string> keys; */
