...
plot for [i=1:words(files)] word(files, i) using 1:4:5 with errorlines linestyle i +8 title word(files, i)."-test"

replot for [i=1:words(files)] word(files, i) using 1:2:3 with errorlines linestyle i title word(files, i)."-train"
