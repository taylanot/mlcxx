...
@nb.njit(cache=True)
def EE_Linear_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner):
    var = numba_config 
...
@nb.njit(cache=True)
def EE_Bayes_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner):
    var = numba_config 
    run = numba_config_runner
    overall_ee = [ ] 
    err = [ ]
...
@nb.njit(cache=True)
def EE_Ridge_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner):
    var = numba_config 
    run = numba_config_runner
    overall_ee = [ ] 
...
@nb.njit(cache=True)
def EE_SGD_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner):
    var = numba_config 
    run = numba_config_runner
    overall_ee = [ ] 
    for lr in var['lr']:
...
def EE(seed, model_tag, run_tag, numba_config, numba_config_runner):
    var = numba_config 
    run = numba_config_runner
    set_seed(seed)
    ...
    if model_tag == 'Linear':
        return EE_Linear_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner) 
    elif model_tag == 'Bayes':
        return EE_Bayes_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner) 
    elif model_tag == 'Ridge':
        return EE_Ridge_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner) 
    elif model_tag == 'SGD':
        return EE_SGD_CALC(xtrn_dist, xtst_dist, a_dist, model_tag, run_tag, numba_config, numba_config_runner)
...
def main(seed, config, model_tag, run_tag, numba_config, numba_config_runner, SUPPORTED_MODELS):
    ...
    res = EE(seed, model_tag, run_tag, numba_config, numba_config_runner)
    return res
